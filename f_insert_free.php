...
Freier Tag Mitarbeiter <?php echo $mitarbeiter ?>
<br><br>
<center>
 <a href="http://213.23.35.50:8688/bedaplan/insert_free.php?current_user=<?php echo $mitarbeiter ?>"  target="_blank"><img src="frei.jpg" border=0></a><br><br><br>
